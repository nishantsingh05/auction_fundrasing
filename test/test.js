...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return auctionInstance.bid({from:accounts[1]},0,6)
    .then(function (result) {
      /*
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      assert.notEqual(result[0],'0x0000000000000000000000000000000000000000', 'winner(0) address is not the default address' );
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result[1],'0x0000000000000000000000000000000000000000', 'winner(1) address is not the default address' );
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
                assert.notEqual(result[2],'0x0000000000000000000000000000000000000000', 'winner(2) address is not the default address' );
    })
  });
});